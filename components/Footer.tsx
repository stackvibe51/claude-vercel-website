    ...
    <footer className="border-t border-white/[0.06] bg-[#070F1E]">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-5 gap-10">
        ...
        <div className="md:col-span-2">
          <Image src="/logo/logo-light.png" alt="StackVibeAI" width={480} height={281} className="h-28 w-auto mb-5" />
        ...
        <div>
          ...
          <p className="text-sm text-slate-400 mb-5">UK · India · USA</p>
          <CalendlyButton className="px-4 py-2.5 rounded-lg bg-[#8B5CF6] hover:bg-[#7C3AED] text-sm font-semibold text-white transition-colors cursor-pointer">
      ...
      <div className="border-t border-white/[0.04] max-w-7xl mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://linkedin.com/company/stackvibeai" target="_blank" rel="noopener noreferrer"
